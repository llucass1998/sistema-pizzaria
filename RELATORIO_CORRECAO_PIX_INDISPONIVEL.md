...
- Se não existir ou for apagada no ADM, ele **exibe de forma amigável**: *"Pagamento via PIX temporariamente indisponível."* e impede que ele feche o pedido se selecionar esta opção de pagamento "fantasma".

...
export default function OnboardingPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch('/api/public/saas/onboarding', {
        method: 'POST',
      ...
      <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
        <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full text-center">
          ...
          <p className="text-slate-600 mb-8">
            Sua loja <strong>{formData.storeName}</strong> está pronta. Você será redirecionado para o painel de administração...
          </p>
    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-slate-50">
      ...
      <div className="md:w-1/2 bg-gradient-to-br from-red-600 to-red-800 text-white p-8 md:p-12 flex flex-col justify-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-lg mx-auto">
          ...
          <h1 className="text-4xl font-extrabold mb-4 leading-tight">Venda mais com o melhor sistema de Delivery.</h1>
          <p className="text-red-100 text-lg mb-8">
            Tenha seu próprio site, painel administrativo, PDV de balcão e integração com KDS em menos de 1 minuto.
          </p>
          <ul className="space-y-4">
            {['Sem comissões por venda', 'Gestão completa de estoque', 'Rotas de motoboy automatizadas'].map((item, i) => (
      ...
      <div className="md:w-1/2 flex items-center justify-center p-8 md:p-12 bg-white">
        <div className="max-w-md w-full">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label className="block text-sm font-bold text-slate-700 mb-1">Endereço da sua loja (Link)</label>
              ...
              <p className="text-xs text-slate-400 mt-1">Seu site ficará em: seudominio.app.com/?tenant={formData.slug || 'slug'}</p>
            </div>
            ...
            <p className="text-center text-xs text-slate-500 mt-4">
              Ao criar sua conta você concorda com nossos <a href="#" className="text-red-600 hover:underline">Termos de Serviço</a> e <a href="#" className="text-red-600 hover:underline">Política de Privacidade</a>.
            </p>
          </form>
        </div>
      </div>

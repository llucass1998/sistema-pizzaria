    ...
    <ToastContext.Provider value={{ showToast, showSuccess, showError, showInfo }}>
      ...
      {toast && (
        <div className="fixed inset-0 z-[99999] flex items-center justify-center pointer-events-none p-4">
          ...
          />
          <div
            className={`relative flex max-w-md w-full items-center gap-3 rounded-2xl p-5 shadow-[0_20px_50px_rgba(0,0,0,0.3)] pointer-events-auto transition-all duration-300 ease-out transform scale-100 opacity-100 ${
              toast.type === 'success'

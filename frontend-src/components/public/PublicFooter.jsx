      ...
      <div className="mx-auto w-full max-w-7xl px-4 py-12">
          ...
          <div className="flex flex-col items-start">
            <div className="flex items-center gap-3 mb-4">
              {store?.logoUrl ? (
                ...
                <div className="w-12 h-12 rounded-full bg-slate-300 dark:bg-slate-800 flex items-center justify-center text-xl">
                  🍕
                </div>
              )}
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 mb-4">
              Pizzas artesanais, massa leve e recheio caprichado. Peça online e receba rápido no
              conforto da sua casa.
            </p>
            <div
              className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-bold ${isOpen ? 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400' : 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400'}`}
            >
              <span
                className={`w-2 h-2 rounded-full ${isOpen ? 'bg-emerald-500' : 'bg-red-500'} animate-pulse`}
              ></span>
            ...
            <div className="space-y-3 text-sm">
              ...
              {instagramUrl && (
                <a
                  ...
                  className="flex items-center gap-2 hover:text-pink-600 dark:hover:text-pink-400 transition"
                >
                  <Instagram size={16} />
                  <span>Instagram</span>
                </a>
        ...
        <div className="mt-12 pt-8 border-t border-slate-200 dark:border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-slate-500 dark:text-slate-400">
            &copy; {new Date().getFullYear()} {store?.name || 'Pizzaria'}. Todos os direitos
            reservados.
          </p>
